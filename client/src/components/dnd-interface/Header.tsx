...
export default function Header({ walletAddress: propWallet }: HeaderProps) {
    ...
    return (
        <div className="relative z-50 shrink-0 border-b border-white/6 bg-[linear-gradient(180deg,rgba(14,14,15,0.94)_0%,rgba(9,9,10,0.90)_100%)] px-3 py-2 shadow-[0_16px_36px_rgba(0,0,0,0.38)] backdrop-blur-2xl md:px-4">
            ...
            <div className="relative z-10 flex flex-col gap-2 xl:flex-row xl:items-center xl:justify-between">
                <div className="flex flex-col gap-2 xl:flex-row xl:items-center">
                    <div className="group relative overflow-hidden rounded-[20px] border border-amber-400/16 bg-[linear-gradient(145deg,rgba(28,24,20,0.94),rgba(11,11,12,0.96))] px-3 py-2 shadow-[inset_0_1px_0_rgba(255,255,255,0.05),0_12px_24px_rgba(0,0,0,0.3)]">
                        ...
                        <div className="relative flex items-center gap-2.5">
                            <div className="flex h-8 w-8 items-center justify-center rounded-xl border border-amber-400/18 bg-[radial-gradient(circle_at_30%_30%,rgba(244,211,146,0.16),rgba(74,53,24,0.22)_60%,rgba(19,17,15,0.95)_100%)] shadow-[inset_0_1px_0_rgba(255,255,255,0.08),0_6px_16px_rgba(0,0,0,0.22)]">
                                <Crown className="h-3.5 w-3.5 text-amber-200" />
                            </div>
                            <div className="min-w-0">
                                <div className="text-[0.46rem] font-inter font-semibold uppercase tracking-[0.28em] text-stone-500">
                                    OneChain Campaign
                                </div>
                                <h1 className="text-[1rem] font-cinzel font-semibold uppercase tracking-[0.14em] text-transparent bg-clip-text bg-[linear-gradient(180deg,#f7e3b0_0%,#d8ab53_55%,#8e6632_100%)]">
                                    NFT-DND
                                </h1>
                            </div>
                        </div>
                    ...
                    {playerId && (
                        <div className="flex flex-1 flex-wrap items-center gap-2">
                            {navigationMenus.map((menu) => {
                                ...
                                return (
                                    <DropdownMenu key={menu.key}>
                                        <DropdownMenuTrigger className="group flex h-9 items-center gap-2 rounded-xl border border-white/6 bg-[linear-gradient(180deg,rgba(18,18,20,0.92),rgba(13,13,14,0.9))] px-3 text-[0.62rem] font-inter font-semibold uppercase tracking-[0.22em] text-stone-300/85 transition-all hover:border-amber-400/24 hover:bg-[linear-gradient(180deg,rgba(31,26,20,0.96),rgba(16,14,13,0.92))] hover:text-amber-100 outline-none">
                                            <Icon className="h-3.5 w-3.5 text-stone-400 transition-colors group-hover:text-amber-300" />
                                            <span>{menu.label}</span>
                                            <ChevronDown className="h-3 w-3 text-stone-500 transition-transform group-data-[state=open]:rotate-180" />
                                        </DropdownMenuTrigger>
                            ...
                            <button
                                ...
                                className="group flex h-9 items-center gap-2 rounded-xl border border-amber-400/22 bg-[linear-gradient(180deg,rgba(77,53,23,0.55),rgba(31,24,17,0.96))] px-3 text-[0.62rem] font-inter font-semibold uppercase tracking-[0.22em] text-amber-100 shadow-[inset_0_1px_0_rgba(255,255,255,0.05),0_10px_20px_rgba(0,0,0,0.24)] transition-all hover:border-amber-300/45"
                            >
                                <Sparkles className="h-3.5 w-3.5 text-amber-300 transition-transform group-hover:scale-110" />
                ...
                <div className="flex flex-wrap items-center gap-2 xl:justify-end">
                    <div className="flex min-w-[128px] items-center gap-2.5 rounded-[18px] border border-white/6 bg-[linear-gradient(180deg,rgba(17,18,19,0.95),rgba(11,12,13,0.92))] px-3 py-2 shadow-[inset_0_1px_0_rgba(255,255,255,0.04),0_8px_20px_rgba(0,0,0,0.22)]">
                        <div className={`h-2 w-2 rounded-full ${currentTurn === 'player' ? 'bg-emerald-400 shadow-[0_0_10px_rgba(52,211,153,0.7)]' :
                        ...
                        <div className="min-w-0">
                            <div className="text-[0.46rem] font-inter font-semibold uppercase tracking-[0.26em] text-stone-500">
                                Turn State
                            </div>
                            <div className="mt-0.5 text-[0.72rem] font-cinzel font-semibold uppercase tracking-[0.15em] text-stone-100">
                                {currentTurn}
                            </div>
                        </div>
                    </div>
                    ...
                    {playerId ? (
                        <DropdownMenu>
                            <DropdownMenuTrigger className="group flex min-w-[190px] items-center gap-2.5 rounded-[18px] border border-white/7 bg-[linear-gradient(180deg,rgba(21,21,23,0.96),rgba(14,14,16,0.92))] px-3 py-2 text-sm text-amber-50 shadow-[inset_0_1px_0_rgba(255,255,255,0.04),0_8px_20px_rgba(0,0,0,0.22)] outline-none transition-all hover:border-amber-400/24">
                                <div className="flex h-8 w-8 items-center justify-center rounded-xl border border-amber-400/16 bg-[linear-gradient(180deg,rgba(59,46,27,0.46),rgba(20,19,17,0.92))]">
                                ...
                                <div className="min-w-0 flex-1 text-left">
                                    ...
                                    <div className="mt-0.5 truncate text-[0.78rem] font-medium text-stone-100">
                                        {shortWallet}
                                    </div>
                                </div>
